...
(function (root, factory) {
  ...
  const TEXT = {
    ...
    labels: {
      ...
      envelope: 'nucleus envelope', pore: 'pore', chr11: 'chromosome 11', chr11Both: 'your two chromosome 11s', geneHere: 'insulin gene',
      insulinGene: 'insulin gene', nextGene: 'the next gene', start: 'start', end: 'end', tooSmall: 'letters too small to show',
      threadNote: 'drawn far shorter: stretched out, this DNA is about 4.6 cm long',
    ...
    alt: {
      ...
      nucleus: 'The nucleus with pores in its envelope and its chromosomes; your two chromosome 11s are tinted.',
      chromosome: 'One chromosome 11 as a loose tangle of thread, drawn far shorter than it is; the insulin gene is marked near one end.',
      stretch: 'A stretch of DNA drawn straight: the insulin gene coloured, and the end of the next gene in grey.',
      ...
      fold: 'The chain, without its first 24 amino acids, folding up on itself.',
      cut: 'Insulin: two short chains held together by links, with the middle piece cut away beside them.',
      muscle: 'Insulin reaching a muscle cell: proteins that carry glucose, stored inside the cell, move into its membrane.',
      membrane: 'A patch of membrane with glucose outside.',
      machine: 'A glucose transporter carrying glucose across the membrane, shown much slower than in your cells.',
    ...
    simplified: [
      ...
      'Insulin’s ribosomes sit on a membrane network next to the nucleus. The chain’s first 24 amino acids dock them there, then are cut off.',
    ...
    scenes: {
      a0: [
        ...
        { who: 'narrator', text: 'Watch and see.' },
      ],
      ...
      a5: [{ who: 'narrator', text: 'This is one of your two chromosome 11s. In a cell that is not dividing, it is a loose tangle, not the X shape seen in pictures.' }],
      a7: [{ who: 'narrator', text: 'Along the DNA are genes. The coloured stretch is the insulin gene, one of about 20,000 genes for proteins in your DNA.' }],
      ...
      c5: [
        { who: 'narrator', text: 'The machine is called RNA polymerase. The copy is called messenger RNA, or mRNA.' },
        { who: 'narrator', text: 'Built across from the other strand, the copy spells out the gene’s letters, with U in place of T.' },
      ],
      d1: [{ who: 'narrator', text: 'Here is the nucleus again, with the finished copy near a pore.' }],
      ...
      e2: [{ who: 'narrator', text: 'Each group of three letters, a codon, stands for one amino acid or for stop. Amino acids are the building blocks of a protein.' }],
      ...
      f1: [{ who: 'narrator', text: 'The first 24 amino acids are cut off as the chain is made, and the rest folds up on itself.' }],
      f2: [{ who: 'narrator', text: 'A middle piece is cut out. What is left is insulin: two short chains held together by links.' }],
      f3: [{ who: 'narrator', text: 'Insulin travels in your blood. Where it reaches muscle cells, stored proteins that carry glucose move into their membranes.' }],
      ...
      f7: [
        ...
        { who: 'narrator', text: 'Nobody did. A gene was copied, the copy was read, and the chain folded. Each step happened because molecules bumped together and fit.' },
    ...
    d1: {
      ...
      options: [
        ...
        { t: 'It becomes part of the protein.', mc: 'DNA_DIRECT',
          fb: 'The gene is never built into anything. The protein is built from the mRNA copy, out in the cell.' },
      ],
    },
    f4g: {
    ...
    cardsF7: {
      ...
      enzyme: { job: 'Break glucose down, releasing energy.', name: 'Glucose-processing enzymes', where: 'Work inside the cell' },
      insulin: { job: 'A signal in your blood: stored transporters move into muscle cell membranes.', name: 'Insulin', where: 'Travels in the blood' },
    },
